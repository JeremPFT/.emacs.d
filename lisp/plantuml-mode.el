...
(defvar plantuml-indent-regexp-note-jpi-start "^\s*note\s+\\(as\\|left\\|right\\)[^a-z].*$"
...
(defvar plantuml-indent-regexp-end (list plantuml-indent-regexp-block-end
                                         ...
                                         ;; jpi plantuml-indent-regexp-activate-end
