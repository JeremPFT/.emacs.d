...
(defconst asn1-data-faces-default
  `((asn1-skeleton-face		"blue"		nil nil nil	nil	nil
	,(asn1-lg "Mots-cles participant a la structure d'un module"
	   "module skeleton"))
    (asn1-type-face		"cadetblue"	nil nil nil	nil	nil
	,(asn1-lg "Mots-cles designant des types" "basic types"))
    (asn1-structured-type-face	"darkgoldenrod"	nil nil nil	nil	nil
	,(asn1-lg "Mots-cles concernant les types structures"
	   "structured types"))
    (asn1-option-face		"grey40"	nil nil nil	nil	nil
	,(asn1-lg "Mots-cles OPTIONAL/DEFAULT" "OPTIONAL/DEFAULT"))
    (asn1-subtyping-face	"forestgreen"	nil nil nil	nil	nil
	,(asn1-lg "Mots-cles ayant trait au sous-typage"
	   "subtyping keywords"))
    (asn1-exps-face		"forestgreen"	nil nil nil	nil	nil
	,(asn1-lg "Expressions de sous-typage" "subtyping exps"))
    (asn1-tag-face		"grey40"	nil nil nil	nil	nil
	,(asn1-lg "Mots-cles et expressions concernant les tags" "tags"))
    (asn1-values-face		"MediumAquamarine" nil nil nil	nil	nil
...
; 	,(asn1-lg "Chaines de caracteres" "Strings"))
    (asn1-class-face		"medium purple"	nil nil nil	nil	nil
