((last-sort-comparer
 ...
 (last-latest-bookmark-alist #1=(#("README.org" 0 10
			     ...
			     #11=(#("generator" 0 9
				  ...
				  (position . 63)
				  (filename . #12="c:/Users/jpiffret/AppData/Roaming/Ingenico_Workspace/scheme_generator/GenDllSch/")
				  (dired-directory . #12#)
				  (dired-marked)
				  (dired-switches . "-al")
				  (dired-subdirs)
				  (dired-hidden-dirs)
				  (handler . bmkp-jump-dired))
			     #13=(#("Ingenico_Workspace" 0 18
				    (bmkp-full-record #13#))
				  (time 24399 29245 983857 0)
				  (visits . 0)
				  (tags "ingenico")
				  ...
				  (position . 1902))
			     #14=(#("_BbvaTkGen__declarations.h" 0 26
				    (bmkp-full-record #14#))
				  (tags "ingenico")
			     ...
			     #15=(#("BbvaTkGen__definitions.c" 0 24
				    (bmkp-full-record #15#))
				  (tags "ingenico")
			     ...
			     #16=(#("BbvaTkGenVerif__definitions.c" 0 29
				    (bmkp-full-record #16#))
				  (tags "ingenico")
			     ...
			     #17=(#("BbvaTkGenVerif__declarations.h" 0 30
				    (bmkp-full-record #17#))
				  (tags "ingenico")
			     ...
			     #18=(#("BbvaTkGenRun__definitions.c" 0 27
				    (bmkp-full-record #18#))
				  (tags "ingenico")
			     ...
			     #19=(#("BbvaTkGenRun__declarations.h" 0 28
				    (bmkp-full-record #19#))
				  (tags "ingenico")
			     ...
			     #20=(#("BbvaKeyStoreVerif__definitions.c" 0 32
				    (bmkp-full-record #20#))
				  (tags "ingenico")
			     ...
			     #21=(#("BbvaKeyStoreVerif__declarations.h" 0 33
				    (bmkp-full-record #21#))
				  (tags "ingenico")
			     ...
			     #22=(#("BbvaKeyStoreRun__definitions.c" 0 30
				    (bmkp-full-record #22#))
				  (tags "ingenico")
			     ...
			     #23=(#("BbvaKeyStoreRun__declarations.h" 0 31
				    (bmkp-full-record #23#))
				  (tags "ingenico")
			     ...
			     #24=(#("BbvaKeyStore__definitions.c" 0 27
				    (bmkp-full-record #24#))
				  (tags "ingenico")
			     ...
			     #25=(#("BbvaKeyStore__declarations.h" 0 28
				    (bmkp-full-record #25#))
				  (tags "ingenico")
			     ...
			     #26=(#("SUPTER-7682_mexique" 0 19
				  ...
				  (dired-hidden-dirs)
				  (handler . bmkp-jump-dired))
			     #27=(#("_BbvaKeyStore__declarations.h" 0 29
				    (bmkp-full-record #27#))
				  (annotation)
				  (tags "ingenico")
 ...
 (last-bmenu-filter-pattern . #32="")
 (last-bmenu-title . #32#)
 (last-bmenu-bookmark . #33#)
 (last-specific-buffer . #32#)
 (last-specific-file . #32#)
