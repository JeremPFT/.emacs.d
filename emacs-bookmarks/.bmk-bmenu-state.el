((last-sort-comparer
 ...
 (last-latest-bookmark-alist #1=(#("README.org" 0 10
			     ...
			     #14=(#("Ingenico_Workspace" 0 18
				  ...
				  (position . 1902))
			     #15=(#("_BbvaTkGen__declarations.h" 0 26
				    (bmkp-full-record #15#))
				  (tags "ingenico")
			     ...
			     #16=(#("BbvaTkGen__definitions.c" 0 24
				    (bmkp-full-record #16#))
				  (tags "ingenico")
			     ...
			     #17=(#("BbvaTkGenVerif__definitions.c" 0 29
				    (bmkp-full-record #17#))
				  (tags "ingenico")
			     ...
			     #18=(#("BbvaTkGenVerif__declarations.h" 0 30
				    (bmkp-full-record #18#))
				  (tags "ingenico")
			     ...
			     #19=(#("BbvaTkGenRun__definitions.c" 0 27
				    (bmkp-full-record #19#))
				  (tags "ingenico")
			     ...
			     #20=(#("BbvaTkGenRun__declarations.h" 0 28
				    (bmkp-full-record #20#))
				  (tags "ingenico")
			     ...
			     #21=(#("BbvaKeyStoreVerif__definitions.c" 0 32
				    (bmkp-full-record #21#))
				  (tags "ingenico")
			     ...
			     #22=(#("BbvaKeyStoreVerif__declarations.h" 0 33
				    (bmkp-full-record #22#))
				  (tags "ingenico")
			     ...
			     #23=(#("BbvaKeyStoreRun__definitions.c" 0 30
				    (bmkp-full-record #23#))
				  (tags "ingenico")
			     ...
			     #24=(#("BbvaKeyStoreRun__declarations.h" 0 31
				    (bmkp-full-record #24#))
				  (tags "ingenico")
			     ...
			     #25=(#("BbvaKeyStore__definitions.c" 0 27
				    (bmkp-full-record #25#))
				  (tags "ingenico")
			     ...
			     #26=(#("BbvaKeyStore__declarations.h" 0 28
				    (bmkp-full-record #26#))
				  (tags "ingenico")
			     ...
			     #27=(#("SUPTER-7682_mexique" 0 19
				  ...
				  (dired-hidden-dirs)
				  (handler . bmkp-jump-dired))
			     #28=(#("_BbvaKeyStore__declarations.h" 0 29
				    (bmkp-full-record #28#))
				  (annotation)
				  (tags "ingenico")
 ...
 (last-bmenu-filter-pattern . #33="")
 (last-bmenu-title . #33#)
 (last-bmenu-bookmark . #34#)
 (last-specific-buffer . #33#)
 (last-specific-file . #33#)
 (last-bmenu-toggle-filenames . t)
 (last-bmenu-before-hide-marked-alist)
 (last-bmenu-before-hide-unmarked-alist)
 (last-bookmark-file . "c:/Users/jeremy/AppData/Roaming/.emacs.d/emacs-bookmarks/bmk.emacs")
 (last-previous-bookmark-file . "c:/Users/jeremy/AppData/Roaming/.emacs.d/emacs-bookmarks/bmk.emacs"))
