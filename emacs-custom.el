 ...
 '(safe-local-variable-values
   (quote
    ((eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/ata")
     (eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/ata-application")
     ...
     (eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/ata-application-service")
     (eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/ata-application-service-tests")
     ...
     (eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/ata-model")
     (eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/ata-model-object")
     (eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/ata-model-object-tests")
     (eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/ata-model-service")
     (eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/ata-model-service-tests")
     (eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/ata-repository")
     (eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/ata-repository-tests")
     (eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/ata-testing_data")
     ...
     (eval load "~/workspace/ada_test_architectures/src/.emacs_prj_settings/utils-tests"))))
 '(show-paren-mode t)
