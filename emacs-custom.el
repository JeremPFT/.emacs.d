 ...
 '(safe-local-variable-values
   (quote
    ((eval load "~/workspace/ada_test_architectures/modules/ata/ata")
     ...
     (eval load "~/workspace/ada_test_architectures/modules/ata_model/ata_model")
     (eval load "~/workspace/ada_test_architectures/modules/ata_model_object/ata_model_object")
     (eval load "~/workspace/ada_test_architectures/modules/ata_model_service/ata_model_service")
     (eval load "~/workspace/ada_test_architectures/modules/ata_repositories/ata_repositories")
     (eval load "~/workspace/ada_test_architectures/modules/run/run")
     (eval load "~/workspace/ada_test_architectures/modules/test_run/test_run")
     (eval load "~/workspace/ada_test_architectures/modules/test_utils/test_utils")
     (eval load "~/workspace/ada_test_architectures/modules/utils/test/utils_test")
     (eval load "~/workspace/ada_test_architectures/modules/utils/utils"))))
 '(show-paren-mode t)
